...
const Professional = ({ Data, PrintRef }) => {
  ...
  return (
    <div className='paper'>
      <div ref={PrintRef}>
        <div className='paper-header-pro'>
          {Data.Header.ProfileImg && (
            <div className='image-holder-pro'>
              <img src={ImageUrl} className='cv-img-pro' />
            </div>
          )}
          <div className='header-info-pro'>
            <h5>
        ...
        <div>
          {/* CONTACT */}
          <div className='header-contact-pro'>
            <h6>
        ...
        <div className='paper-body-pro'>
          ...
          {/* SECTION 2 */}
          <div className='section-pro-sm'>
            <div className='item skills'>
              <div className='title-pro'>
                <div style={{ paddingTop: "0px" }} className='title-icon-pro'>
                  {NewComponent}
                </div>
                <h4>Competences</h4>
              </div>
              <div className='container'>
                <div className='row justify-content-center'>
                  {Data.Competences.map((Cmpt) => {
                    return (
                      <span key={Cmpt.key} className='skill col-auto'>
